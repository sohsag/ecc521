...
def SWAP_coordinate(b: int, x0: int, x1: int):
    ...
    mask = _sage_const_0 
    for _ in range(K.characteristic().nbits()-_sage_const_1 ):
...
def ladder(P: ProjectivePointXZ, k: int):
    ...
    n_bits = ceil(log(E.order(), _sage_const_2 ))
    
    for i in range(n_bits-_sage_const_2 , -_sage_const_1 , -_sage_const_1 ):
        swap_bit = (k >> i) & _sage_const_1 
